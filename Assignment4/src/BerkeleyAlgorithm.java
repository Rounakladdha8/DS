...
public class BerkeleyAlgorithm {
	public static void main(String[] args) throws ParseException {
		...
		System.out.print("How many clients are there in your network?\nEnter count: ");
	...
	public static void berkeleyAlgorithm(String[] timeString) throws ParseException {
		...
		avg /= n;
		System.out.println("Fault tolerant average = " + avg / (1000 * 60)); // Displaying fault-tolerant average in
																				// minutes
		...
		for (int i = 0; i < n; i++) {
			...
			System.out.println("Clock " + i + " adjustment = " + offset / (1000 * 60)); // Displaying adjustment value
																						// in minutes
		}
